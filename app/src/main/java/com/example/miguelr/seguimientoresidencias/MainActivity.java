...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Carreras carreras = new Carreras(this);
        cartaAceptacion ca = new cartaAceptacion(this);
        cartaDePresentacion cp = new cartaDePresentacion(this);
        expedienteFinal ex = new expedienteFinal(this);
        solicitudDeResidencias sol = new solicitudDeResidencias(this);
